...
NumericalRelaxation.convexify(prev_F,prev_bt::BinaryLaminationTree,hroc::HROC,buffer::HROCBuffer,constraint,irr,W::FUN,F::T1,xargs::Vararg{Any,XN}) where {T1,FUN,XN}
```
